...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加商品','${pageContext.request.contextPath}/goods/add')"><i
    ...
    <table class="layui-table">
        ...
        <c:forEach items="${goods}" var="goods">
            <tr>
                <td>
                    <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${goods.GNo}'><i
                            class="layui-icon">&#xe605;</i></div>
                </td>
                <td>${goods.GNo}</td>
                <td>${goods.gtNo}</td>
...
<%--                    </a>--%>
                    <a title="删除" onclick="member_del(this,${goods.GNo})" href="javascript:;">
                        <i class="layui-icon">&#xe640;</i>
                    </a>
                </td>
            </tr>
