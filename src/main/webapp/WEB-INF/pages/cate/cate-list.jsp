...
<div class="x-body">
    <xblock>
        ...
        <button class="layui-btn"
                onclick="x_admin_show('添加商品分类','${pageContext.request.contextPath}/cate/insertPage',500,350)"><i
    ...
    <table class="layui-table layui-form">
        ...
        <c:forEach items="${cates}" var="cate">
            ...
            <tr cate-id='${cate.gtNo}' fid='<c:out value="${fid}"></c:out>'>
                <td>
                    <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${cate.gtNo}'><i
                            class="layui-icon">&#xe605;</i></div>
                </td>
                ...
                <td class="td-manage">
                    <button class="layui-btn layui-btn layui-btn-xs"
                            onclick="x_admin_show('编辑','${pageContext.request.contextPath}/cate/updatePage?gtNo=${cate.gtNo}')">
                        <i class="layui-icon">&#xe642;</i>编辑
                    </button>
                    <button class="layui-btn layui-btn-warm layui-btn-xs"
                            onclick="x_admin_show('编辑' ,'${pageContext.request.contextPath}/cate/insertChildrenPage?gtPno=${cate.gtNo}&gtLevel=${cate.gtLevel}')">
                        <i class="layui-icon">&#xe642;</i>添加子栏目
                    </button>
                    <button class="layui-btn-danger layui-btn layui-btn-xs" onclick="member_del(this,'${cate.gtNo}')"
