...
<head>
    <meta charset="UTF-8">
    <title>欢迎页面-liLei小型超市收银系统</title>
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <table class="layui-table" lay-skin="line">
                ...
                <tr>
                    <td>
                        <a class="x-a" href="/" target="_blank">好好学习天天向上</a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a class="x-a" href="/" target="_blank">doro</a>
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <fieldset class="layui-elem-field">
        ...
        <div class="layui-field-box">
            <table class="layui-table">
                ...
                <tr>
                    <th>开发者</th>
                    <td>liLei(3234755499@qq.com)</td>
                </tr>
                </tbody>
            </table>
        </div>
    </fieldset>
    <blockquote class="layui-elem-quote layui-quote-nm">重庆对外经贸学院——计算机科学与技术1班
    </blockquote>
</div>
