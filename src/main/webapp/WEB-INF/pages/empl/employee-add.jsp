...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form">
        <div class="layui-row layui-col-md6">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">
                    <span class="x-red">*</span>RFID会员卡号
                </label>
                <div class="layui-input-inline">
        ...
        <div class="layui-row layui-col-md6">
            <div class="layui-form-item">
                <label class="layui-form-label">
                    <span class="x-red">*</span>入会时间
                </label>
                <div class="layui-input-inline">
                    <input class="layui-input" placeholder="入会时间" name="EJointime" id="joinTime"
                           lay-verify="required">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" placeholder="出生日期" name="EBirthday" id="birthday"
                           lay-verify="required">
                </div>
            </div>
