...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn"
                onclick="x_admin_show('添加活动','${pageContext.request.contextPath}/prom/add',600,400)"><i
    ...
    <table class="layui-table layui-form">
        ...
        <c:forEach items="${pageInfo.list}" var="prom">
            <tr>
                <td>
                    <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='${prom.evNo}'><i
                            class="layui-icon">&#xe605;</i></div>
                </td>
                <td>${prom.evNo}</td>
                <td>${prom.evName}</td>
    ...
    <div class="page">
        <div>
            <c:if test="${pageInfo.hasPreviousPage}">
                <a class="prev"
                   href="${pageContext.request.contextPath}/prom/list?page=${pageInfo.prePage}">&lt;&lt;</a>
            </c:if>
            ...
            <c:if test="${pageInfo.hasNextPage}">
                <a class="next"
                   href="${pageContext.request.contextPath}/prom/list?page=${pageInfo.nextPage}">&gt;&gt;</a>
            </c:if>
        </div>
    </div>
